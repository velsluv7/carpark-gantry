...
//msgid-8bits, rest binary
int GetData(char *message,int data_tobe_extracted,unsigned char *temp)
{
	...
	switch(data_tobe_extracted)
	{
        ...
        if(msgid == 16)
		{
            ...
            if(0x10==(data1&0x10))
            {
                ...
                data_extracted = 0; /* Alarm Triggered */
            }
            else
            {
                printf("Alarm Reset\n");
                data_extracted = 0; /* Alarm Reset */            
            }
            if(0x08==(data1&0x08))
            {
                printf("Power Supply CutOff\n");
                data_extracted = 0; /* Power Supply CutOff */
            }
            else
            {
                printf("Power Supply Resume\n");
                data_extracted = 0; /* Power Supply Resume */            
            }           
        }
        break;      
	}
