...
int
Car02_CC( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )

{

	char message_id_006[50];
	message_id_006[0] = 0x06;  // iu  ca - 06 com - 08
	message_id_006[1] = 0x9C;
	message_id_006[2] = 0x20;
	message_id_006[3] = 0x21;
	message_id_006[4] = 0x90;
