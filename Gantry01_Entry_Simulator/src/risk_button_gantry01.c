...
int EntrG01_coid;
char rmsg[200];
char *message_id_0002;
char disp_buff[200];
char debug_buff[200];
int i,j,sizeofrmsg;

int
risk_button_gantry01( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	{
	message_id_0002="0000001001011000@Gantry Open$Emergency Exit";
	...
	if (MsgSend (EntrG01_coid,message_id_0002,strlen (message_id_0002)+1,rmsg,sizeof (rmsg)) == -1)
				{
	...
	if (strlen (rmsg) > 0)
				{
					...
					PtSetResource(ABW_EntrG01firealarm,Pt_ARG_ONOFF_STATE,1,0);
				}
