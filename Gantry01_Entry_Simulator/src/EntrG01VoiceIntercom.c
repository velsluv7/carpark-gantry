...
int
EntrG01VoiceIntercom( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )

	{
	message_id_012[0] = 0x0C;
	message_id_012[1] = 0x10;
	message_id_012[2] = 0x1C;
	message_id_012[3] = 0x00;
	...
	if ((EntrG01_coid = name_open(ATTACH_POINT, 0)) == -1) {
		...
		if (MsgSend (EntrG01_coid,message_id_012,strlen (message_id_012)+1,rmsg,sizeof (rmsg)) == -1)
					{
