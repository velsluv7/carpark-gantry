...
risk_button_gantry01( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	{
	message_id_002="0000001001011000@Gantry Open$Emergency Exit";
	...
	if (strlen (rmsg) > 0)
				{
					...
					PtSetResource(ABW_EntrG02Antenna,Pt_ARG_ONOFF_STATE,1,0);
					//PtSetResource(ABW_EntrG01_firealarm,Pt_ARG_ONOFF_STATE,1,0);
				}
